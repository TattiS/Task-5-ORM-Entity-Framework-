	...
	public class DataSource
	{
		...
		private IEnumerable<Departure> departures = new List<Departure> {
			new Departure { Id = 1, FlightId=2, DepartureDate=DateTime.Parse("2018-01-11T15:45:00"), PlaneItem=new Plane { Id = 1, Name="Boeing 787",
				...
				CrewItem =new Crew{ Id=1, PilotId=1, Stewardesses=new List<Stewardess>(){ new Stewardess { Id = 1, Name ="Eve", Surname="Fairy", BirthDate = DateTime.Parse("2001-06-12") }, new Stewardess { Id = 2, Name ="Samantha", Surname="Simson", BirthDate = DateTime.Parse("1999-12-03") }} } },
			new Departure { Id = 2, FlightId=3, DepartureDate=DateTime.Parse("2018-02-13T11:30:00"), PlaneItem=new Plane { Id = 2, Name="Boeing 737",
				...
				CrewItem =new Crew{ Id=2, PilotId=2, Stewardesses=new List<Stewardess>(){ new Stewardess { Id = 3, Name ="Gabrial", Surname="Fate", BirthDate = DateTime.Parse("1998-05-13")  }, new Stewardess { Id = 4, Name ="Hannah", Surname="Screw", BirthDate = DateTime.Parse("1993-07-08") }, new Stewardess { Id = 5, Name ="Jennah", Surname="Johns", BirthDate = DateTime.Parse("1996-04-03") },} } },
			new Departure { Id = 3, FlightId=5, DepartureDate=DateTime.Parse("2018-01-11T15:45:00"), PlaneItem=new Plane { Id = 3, Name="Boeing 777",
				...
				CrewItem =new Crew{ Id=3, PilotId=3, Stewardesses=new List<Stewardess>(){ new Stewardess { Id = 4, Name ="Hannah", Surname="Screw", BirthDate = DateTime.Parse("1993-07-08") }, new Stewardess { Id = 5, Name ="Jennah", Surname="Johns", BirthDate = DateTime.Parse("1996-04-03") }, new Stewardess { Id = 6, Name ="Ivory", Surname="Rocket", BirthDate = DateTime.Parse("1992-08-19")  }} } }
		};
